...
We successfully deployed our full-stack application to Render with both the backend API and React frontend working in production. All baseline features and both custom features are fully functional. The deployment process went smoothly once we had the environment variables configured correctly.

### 2. What were some challenges your group faced in this unit?

The biggest challenge was managing two separate repos and making sure code was pushed to the correct one for deployment. We also had to troubleshoot the PostgreSQL connection on Render and ensure the frontend was pointing to the correct production API URL.

### 3. What were some of the highlights or achievements that you are most proud of in this project?

We are most proud of the dish claiming modal and the filter/sort functionality on the recipes page. The modal provides a smooth user experience by letting users claim dishes without leaving the event page. The recipe filtering makes it easy to find exactly what you need. Seeing the full app come together and work live on Render was very rewarding.

### 4. Reflecting on your web development journey so far, how have you grown since the beginning of the course?

We have grown significantly in understanding full-stack development. At the start of the course, connecting a frontend to a backend felt overwhelming. Now we can design database schemas, build RESTful APIs with Express, create dynamic React frontends, and deploy everything to production. We also improved our collaboration skills through GitHub project management.

### 5. Looking ahead, what are your goals related to web development, and what steps do you plan to take to achieve them?

We want to continue building full-stack applications and explore authentication with OAuth, real-time features with WebSockets, and more advanced deployment strategies. We plan to keep building personal projects, contribute to open source, and apply what we learned in this course to internship and job opportunities.
